...
// import './index.scss';
import '../../styles/containers/Emissions/Emissions.module.scss';
...
import processingAnimation from "../../public/assets/lottefiles/processing.json";
import successAnimation from "../../public/assets/lottefiles/success.json";
import failedAnimation from "../../public/assets/lottefiles/failed.json";
        ...
        <Row>
          <Col>
            <div className="totol-voting-main-container mb-3">
              ...
              <div>
                <Link href="/more"><Button className="back-btn" type="primary">Back</Button></Link>
              </div>
            </div>
          </Col>
        </Row>
...
export default connect(stateToProps, actionsToProps)(Emission);