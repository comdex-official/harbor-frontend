...
const SurplusAuctions = ({
  ...
  const fetchAuctions = (auctionType, offset, limit, isTotal, isReverse) => {
    ...
    queryDutchAuctionsList(
      ...
      (error, result) => {
        ...
        console.log(result, "result Surplus ");
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item) => (
        <>
          {amountConversionWithComma(item?.debtToken?.amount)}{" "} {denomConversion(item?.debtToken?.denom)}
        </>
      ),
    },
    // {
          ...
          quantity: (
            <>
              <div className="assets-withicon display-center">
                ...
                {amountConversionWithComma(item?.collateralToken?.amount)}{" "}
                {denomConversion(item?.collateralToken?.denom)}
              </div>
            </>
          ),
                ...
                <div className="place_bid_modal_container">
                  ...
                  <div className="auction_quantity_container">
                    ...
                    <div className="target_cmst_box">
                      <div className="text">Target {" "}{denomConversion(selectedSingleAuction?.collateralToken?.denom)}</div>
